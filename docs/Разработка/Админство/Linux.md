...
- [Эмуляция сбоев ФС. Ломаем PostgreSQL](https://habr.com/ru/articles/824376/) - пишем fuse на python

# Приколы оболочек

- [Почему порой так сложно вводить текст в терминал](https://habr.com/ru/companies/ruvds/articles/834780/)

# Работа с текстом

- [Запросто собираем базу данных при помощи команд Linux](https://habr.com/ru/articles/857756/)
